...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Equipment.temp'
        db.add_column('hwdoc_equipment', 'temp',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['hwdoc.State']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Equipment.temp'
        db.delete_column('hwdoc_equipment', 'temp_id')
    ...
    models = {
        ...
        'hwdoc.equipment': {
            ...
            'temp': ('django.db.models.fields.related.ForeignKey', [], {'default': '5', 'to': "orm['hwdoc.State']"}),
