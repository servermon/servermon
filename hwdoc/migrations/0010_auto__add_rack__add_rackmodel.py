...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hwdoc_rack', (
            ...
            ('mounted_depth', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10, default=60)),
        ))
        db.send_create_signal('hwdoc', ['Rack'])

        # Adding model 'RackModel'
        db.create_table('hwdoc_rackmodel', (
            ('min_mounting_depth', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10)),
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hwdoc.Vendor'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('height', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10)),
            ('width', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10)),
            ('max_mounting_depth', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
    ...
    models = {
        ...
        'hwdoc.rack': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
	    'mounted_depth': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '10', 'default': '60'})
        },
        'hwdoc.rackmodel': {
