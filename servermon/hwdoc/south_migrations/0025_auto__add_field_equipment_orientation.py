...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Equipment.orientation'
        db.add_column('hwdoc_equipment', 'orientation',
                      self.gf('django.db.models.fields.CharField')(default='Front', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Equipment.orientation'
        db.delete_column('hwdoc_equipment', 'orientation')
