...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('hwdoc', ['Ticket'])

        # Adding M2M table for field equipment on 'Ticket'
        db.create_table('hwdoc_ticket_equipment', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ticket', models.ForeignKey(orm['hwdoc.ticket'], null=False)),
            ('equipment', models.ForeignKey(orm['hwdoc.equipment'], null=False))
        ))
        db.create_unique('hwdoc_ticket_equipment', ['ticket_id', 'equipment_id'])


    def backwards(self, orm):
        # Deleting model 'Ticket'
        db.delete_table('hwdoc_ticket')

        # Removing M2M table for field equipment on 'Ticket'
        db.delete_table('hwdoc_ticket_equipment')
