...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Ticket', fields ['name']
        db.create_unique('hwdoc_ticket', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ticket', fields ['name']
        db.delete_unique('hwdoc_ticket', ['name'])
