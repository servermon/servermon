...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Update.origin'
        db.add_column('updates_update', 'origin', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Update.origin'
        db.delete_column('updates_update', 'origin')
    ...
    models = {
        ...
        'updates.update': {
            ...
            'origin': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
